    ...
    while True:
        ...
        for author in smelly_authors:
            ...
            try:
                ...
                except: trashy_score = 0.000
                print("User {} trashy score is: {}".format(str(author), round(trashy_score,1)))

                if trashy_score >= 0.500 and sub_count > 1:
        ...
        for spam in spam_content:
            ...
            if time.time()-created_time <= 86400*60:
